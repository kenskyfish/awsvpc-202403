...
cd $TEMP_DIR
ls -la
rm -f /home/ubuntu/${1:-username}-$vpn_name-keys.7z
7za a -p${2:-password} /home/ubuntu/${1:-username}-$vpn_name-keys.7z ./*
chown ubuntu:ubuntu /home/ubuntu/${1:-username}-$vpn_name-keys.7z
echo "your file is here: /home/ubuntu/${1:-username}-$vpn_name-keys.7z"
srm -rf $TEMP_DIR